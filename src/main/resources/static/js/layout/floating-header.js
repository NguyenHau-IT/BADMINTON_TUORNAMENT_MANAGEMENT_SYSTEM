...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initScrollBehavior() {
        ...
        // Ensure header is always centered horizontally
        function centerHeader() {
            const windowWidth = window.innerWidth;
            const headerWidth = header.offsetWidth;
            // Already centered via CSS transform: translateX(-50%)
        }
        ...
        function handleScroll() {
            ...
            scrollTimeout = setTimeout(() => {
                ...
                // Don't hide if at top of page (within 50px)
                if (currentScroll < 50) {
                    if (!isHeaderVisible) {
                        showHeader();
                    }
                ...
                lastScroll = Math.max(0, currentScroll); // Prevent negative values on iOS
        ...
        // Ensure header stays visible initially
        showHeader();
    }
