...
public class TournamentController {
    ...
    public String tournamentHome(Model model) {
        ...
        Map<String, Long> categoryStats = tournamentDataService.getStatsByCategory();
        ...
        model.addAttribute("pageDescription",
                "Khám phá và tham gia các giải đấu cầu lông chuyên nghiệp. Xem lịch thi đấu, đăng ký tham gia và theo dõi trực tiếp.");
     ...
     * 
     * @param status   Filter theo trạng thái (optional): upcoming, ongoing,
     *                 registration, completed
     * @param category Filter theo loại (optional): professional, amateur, club,
     *                 youth, etc.
     * @param model    Model để truyền dữ liệu
    ...
    public String listTournaments(
            ...
            switch (sort) {
                case "newest":
                    ...
                    allTournaments.sort((t1, t2) -> {
                        if (t1.getNgayBatDau() == null)
                            return 1;
                        if (t2.getNgayBatDau() == null)
                            return -1;
        ...
        return "tournament/sections/tournament-list";
    }
    ...
    public String tournamentDetail(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-detail";
    }
    ...
    public String tournamentRegister(@PathVariable int id, Model model) {
        try {
            ...
            try {
                isRegistrationOpen = tournamentDataService.isRegistrationOpen(id);
            } catch (Exception e) {
                // Log error nhưng vẫn cho phép hiển thị trang đăng ký
                System.err.println("Error checking registration status: " + e.getMessage());
                e.printStackTrace();
                // Kiểm tra đơn giản dựa vào trạng thái
                isRegistrationOpen = "registration".equals(tournament.getTrangThai());
            }
            ...
            return "tournament/sections/tournament-register";

        } catch (Exception e) {
            System.err.println("Error in tournamentRegister: " + e.getMessage());
            e.printStackTrace();
            return "redirect:/tournaments?error=server-error";
        }
    }

    /**
     * Alternative route: /tournaments/register/{id} → redirect to /{id}/register
     * Để hỗ trợ cả 2 format URL
     */
    @GetMapping("/register/{id}")
    public String tournamentRegisterRedirect(@PathVariable int id) {
    ...
    public String tournamentSchedule(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-schedule";
    }
    ...
    public String tournamentLive(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-live";
    }
    ...
    public String tournamentStandings(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-standings";
    }
    ...
    public String tournamentParticipants(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-participants";
    }
    ...
    public String tournamentRules(@PathVariable int id, Model model) {
        ...
        return "tournament/sections/tournament-rules";
    }
    ...
    public String tournamentHistory(Model model) {
        ...
        return "tournament/sections/tournament-history";
    }
    ...
    public String tournamentCalendar(Model model) {
        ...
        return "tournament/sections/tournament-calendar";
    }
}
